...
#
package WWW::SwaggerClient::Object::GenotypeMethod;
...
__PACKAGE__->class_documentation({description => 'GenotypeMethod Record',
                                  class => 'GenotypeMethod',
                                  required => [], # TODO
}                                 );
