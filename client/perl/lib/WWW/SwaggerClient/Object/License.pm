...
#
package WWW::SwaggerClient::Object::License;
...
__PACKAGE__->class_documentation({description => 'License models, there will be a default license if one is not provided',
                                  class => 'License',
                                  required => [], # TODO
}                                 );
