...
#
package WWW::SwaggerClient::Object::PopulationSubmissionData;
...
__PACKAGE__->class_documentation({description => 'Contains all submissions for a population',
                                  class => 'PopulationSubmissionData',
                                  required => [], # TODO
}                                 );
