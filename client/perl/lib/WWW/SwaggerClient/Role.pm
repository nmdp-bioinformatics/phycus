...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Haplotype Frequency Curation Service',
                          app_version => '1.0.0',
...
WWW::SwaggerClient::Role - a Moose role for the Haplotype Frequency Curation Service

=head2 Haplotype Frequency Curation Service version: 1.0.0
