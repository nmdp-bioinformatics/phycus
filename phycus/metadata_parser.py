...
class HFXMetadata:
    ...
    method: str
    data_source: str
    nomenclature_database: Optional[str] = None
...
class HFXMetadataParser:
    ...
    def _parse_metadata_dict(self, data: dict, filename: str) -> Optional[HFXMetadata]:
    ...
    def parse_hfx_file(self, filepath: Path | str) -> Optional[HFXMetadata]:
    ...
    def parse_json_file(self, filepath: Path | str) -> Optional[HFXMetadata]:
    ...
    def parse_file(self, filepath: Path | str) -> Optional[HFXMetadata]:
